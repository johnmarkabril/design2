    <div class="mail-box-header">
        <h3 style="padding-bottom: 4px;">
            <span class="font-noraml">Subject: </span>Best Sweet and Pastries
            <span class="pull-right font-noraml">From: maegregorio@gmail.com</span>
        </h3>
        <h5>
            <span class="pull-right font-noraml">November 15, 2016 05:15 AM</span>
        </h5>
    </div>
    <div class="mail-box">
        <div class="mail-body">
